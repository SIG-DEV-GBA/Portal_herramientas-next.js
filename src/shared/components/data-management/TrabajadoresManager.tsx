...
import { NotificationModal, ConfirmModal } from '@/shared/components/ui/Modal';
import { useNotification } from '@/shared/hooks/useNotification';
import { useCurrentUser } from '@/shared/hooks/useCurrentUser';
import { FullPageSkeleton } from '@/shared/components/ui/LoadingSkeletons';
...
export function TrabajadoresManager() {
  ...
  const { data: trabajadores = [], error, isLoading, mutate } = useApiData<Trabajador[]>(
    !userLoading && canAccess('trabajadores', 'read') ? '/api/trabajadores?solo_activos=false' : null
  );
