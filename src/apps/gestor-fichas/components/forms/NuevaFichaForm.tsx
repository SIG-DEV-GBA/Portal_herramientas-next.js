...
interface NuevaFichaFormData {
  ...
  trabajador_id: string; // Redactor/Trabajador que hace la ficha
  trabajador_subida_id: string; // Trabajador que sube la ficha a web
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-8">
          ...
          <div className="bg-purple-50 rounded-xl p-6 space-y-6 border border-purple-200">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Redactor/Trabajador que hace la ficha */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-3">
                  Trabajador que hace la ficha
                ...
                <div className="flex gap-3">
                  <div className="relative flex-1">
                    ...
                    >
                      <option value="" className="text-gray-500">✍️ Seleccionar trabajador...</option>
                      {trabajadores.map((t) => (
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-3">
                  Trabajador que sube la ficha a web
