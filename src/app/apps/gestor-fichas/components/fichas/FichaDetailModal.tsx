...
import { Ficha } from "@/app/apps/gestor-fichas/lib/types";
import { fmtDate } from "@/app/apps/gestor-fichas/lib/utils";
...
export default function FichaDetailModal({ ficha, isOpen, onClose }: Props) {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                      ...
                      <div className="space-y-3">
                        {ficha.trabajador_id && (
                          <div>
                            <p className="text-sm text-gray-600">Trabajador Responsable</p>
                            <p className="font-medium">ID: {ficha.trabajador_id}</p>
                          </div>
                        )}
                        {ficha.trabajador_subida_id && (
                          <div>
                            <p className="text-sm text-gray-600">Trabajador que Subió</p>
                            <p className="font-medium">ID: {ficha.trabajador_subida_id}</p>
                          </div>
                        )}
                      </div>
                    </div>
