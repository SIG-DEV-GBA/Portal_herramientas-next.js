// Ranking de temáticas en un periodo (año o rango).
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!desde || !hasta) {
      return NextResponse.json({ error: "Debes indicar ?anio=YYYY o created_desde/hasta" }, { status: 400 });
    }
    ...
    console.error("stats/tematicas-top error:", e?.message, e);
